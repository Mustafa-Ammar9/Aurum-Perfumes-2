        ...
        <article class="product-card" data-name="${escapeHTML(product.name.toLowerCase())}">
          ...
          <div class="product-body">
            ...
            <div class="product-actions">
              ...
              <a class="btn primary" href="https://docs.google.com/forms/d/e/1FAIpQLSdniAImymX2zWlQ_9Mupm8DwRmd5vUGOUprWRrM7CFpAE7SYQ/viewform?usp=publish-editor" target="_blank" rel="noopener noreferrer" aria-label="Order now">
                <i class="bi bi-bag-check" aria-hidden="true"></i> Order Now
              </a>
            </div>
          </div>
        </article>
    ...
    <section class="perfume-detail card">
      ...
      <div class="perfume-detail-body">
        ...
        <div class="perfume-detail-actions">
          <a class="btn primary" href="https://docs.google.com/forms/d/e/1FAIpQLSdniAImymX2zWlQ_9Mupm8DwRmd5vUGOUprWRrM7CFpAE7SYQ/viewform?usp=publish-editor" target="_blank" rel="noopener noreferrer">
            <i class="bi bi-bag-check" aria-hidden="true"></i> Order Now
          </a>
        </div>
      </div>
